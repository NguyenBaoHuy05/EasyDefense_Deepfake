...
# -----------------------------------------------------------------------
import sys
sys.path.append('/data2/mixiaoyue/mixiaoyue/MetaCloak/robust_facecloak')
import random
import wandb
import argparse
import copy
...
from model.db_train import  DreamBoothDatasetFromTensor
from model.db_train import import_model_class_from_model_name_or_path
from generic.data_utils import PromptDataset, load_data
from generic.share_args import share_parse_args
...
def main(args):
    ...
    from attacks.worker.robust_pgd_worker import RobustPGDAttacker
    from attacks.worker.pgd_worker import PGDAttacker
